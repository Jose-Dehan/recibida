...
export function ExperienceShell({ children, centered = false }: { children: ReactNode; centered?: boolean }) {
  return (
    <main className="relative min-h-screen min-h-[100svh] overflow-hidden bg-[#050806] px-5 py-7 sm:px-7 sm:py-11">
      ...
      <div className={`relative z-10 mx-auto w-full max-w-[460px] ${centered ? "flex min-h-[calc(100svh-3.5rem)] flex-col justify-center sm:min-h-[calc(100svh-5.5rem)]" : ""}`}>
        {children}
      </div>
    </main>
  );
