...
export default function HomePage() {
  ...
  return (
    <ExperienceShell centered>
        ...
        <div className="mt-8"><CurrentPriceCard price={price} tierLabel={tierLabel} remainingInTier={remainingInTier} nextTierPrice={nextTierPrice} soldOut={soldOut} featured loading={loading} error={error} /></div>
